...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        :return:
        """
        return ["[PAD]","B-strong", "I-strong", "O", "B-weak", "I-weak", "B-neutral", "I-neutral","X","[CLS]","[SEP]"]
#        return ["[PAD]","B-strong", "I-strong", "O", "X","[CLS]","[SEP]"]
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(label_ids, logits,num_labels,mask):
                ...
                acc = tf.metrics.accuracy(label_ids, predictions)
                return {
                    "acc":acc
                }
                #return {
...
def _write_base(batch_tokens,id2label,prediction,batch_labels,wf,i):
    ...
    if token!="[PAD]" and token!="[CLS]" and true_l!="X":
        ...
        if predict=="X" and not predict.startswith("▁"):
            predict="O"
        #line = "{}\t{}\t{}\n".format(token.decode('utf-8'),true_l,predict)
